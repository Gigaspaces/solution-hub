...
@Documented
@Inherited
@Import(XapRepositoriesRegistrar.class)
public @interface EnableXapRepositories {

    /**
     * Alias for the {@link #basePackages()} attribute. Allows for more concise annotation declarations e.g.:
     * {@code @EnableXapRepositories("org.my.pkg")} instead of {@code @EnableXapRepositories(basePackages="org.my.pkg")}.
     */
