 ...
 *******************************************************************************/
package org.openspaces.test.persistency.cassandra.archive;
...
import org.openspaces.test.persistency.cassandra.CassandraTestServer;
...
public class CassandaraArchiveOperationHandlerTest {
    ...
    private final String TEST_NAMESPACE_XML = "/org/openspaces/test/persistency/cassandra/archive/test-cassandra-archive-handler-namespace.xml";
    private final String TEST_RAW_XML = "/org/openspaces/test/persistency/cassandra/archive/test-cassandra-archive-handler-raw.xml";
	...
	private void configurerTest() throws Exception {
		try(final UrlSpaceConfigurer urlSpaceConfigurer = new UrlSpaceConfigurer("/./space")) {
            GigaSpace gigaSpace;
            
            final IJSpace space = urlSpaceConfigurer.create();
            gigaSpace = new GigaSpaceConfigurer(space).create();

            try(CassandraArchiveOperationHandler archiveHandler =
