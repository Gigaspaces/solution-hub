...
public class ReadByIdsCassandraTest extends AbstractCassandraTest
{
    ...
    public void test()
    {
        ...
        Assert.assertEquals("bad document", (Object)1, doc1.getProperty(keyName));
        Assert.assertEquals("bad document", (Object)2, doc2.getProperty(keyName));
        Assert.assertEquals("bad document", somePropValue, (Object)doc1.getProperty(someProp));
        Assert.assertEquals("bad document", somePropValue, (Object)doc2.getProperty(someProp));
