...
public class NativeExample {
    ...
    public void run() throws InterruptedException {
        log.info("You can use get GigaSpace instance from repository and use advanced features");
        ...
        log.info("For another features please read Gigaspaces Documentation.");
